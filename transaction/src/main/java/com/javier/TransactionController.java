...
public class TransactionController {
	...
	@RequestMapping("/transfer-money/{username}/{accountno}/{toaccountnumber}/{transferamount}")
	public String transferMoney(@PathVariable("username") String username, @PathVariable("accountno") int accountno,
